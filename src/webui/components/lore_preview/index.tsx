...
import { FOUND_ALL_LOST_MINERS, FOUND_HOARD, FOUND_HQ, FOUND_LOST_MINERS } from "../../../core/lore/graphs/events";
import { Cavern } from "../../../core/models/cavern";
import { FAILURE, SUCCESS } from "../../../core/lore/graphs/conclusions";
import styles from "./style.module.scss"

export default function LorePreview({ cavern }: { cavern: Cavern | undefined }) {
  ...
  const tabs = [
    ...
    { name: "Found Hoard", pg: FOUND_HOARD, results: cavern?.lore?.results.foundHoard },
    { name: "Found HQ", pg: FOUND_HQ, results: cavern?.lore?.results.foundHq },
    { name: "Found Lost Miners", pg: FOUND_LOST_MINERS, results: cavern?.lore?.results.foundLostMiners },
    { name: "Found All Lost Miners", pg: FOUND_ALL_LOST_MINERS, results: cavern?.lore?.results.foundAllLostMiners },
  ];
  return (
