...
import './App.css';
import { CavernContext, PseudorandomStream, inferContextDefaults } from '../core/common';
...
function App() {
  ...
  const [cavernContext, setCavernContext] = useState<Partial<CavernContext>>({logger})
