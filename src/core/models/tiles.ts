...
// prettier-ignore
const TILES = {
  FLOOR:              {id:  1, isWall: false, isFluid: false, maxSlope: undefined, crystalYield: 0, oreYield: 0, inspectColor: "#2D004B"},
  ...
  LANDSLIDE_RUBBLE_3: {id: 61, isWall: false, isFluid: false, maxSlope: undefined, crystalYield: 0, oreYield: 0, inspectColor: "#180032"},
  LANDSLIDE_RUBBLE_2: {id: 62, isWall: false, isFluid: false, maxSlope: undefined, crystalYield: 0, oreYield: 0, inspectColor: "#180032"},
  LANDSLIDE_RUBBLE_1: {id: 63, isWall: false, isFluid: false, maxSlope: undefined, crystalYield: 0, oreYield: 0, inspectColor: "#180032"},
  CRYSTAL_SEAM:       {id: 42, isWall:  true, isFluid: false, maxSlope: undefined, crystalYield: 4, oreYield: 4, inspectColor: "#B5FF00"},
  ORE_SEAM:           {id: 46, isWall:  true, isFluid: false, maxSlope: undefined, crystalYield: 0, oreYield: 8, inspectColor: "#9C4108"},
  RECHARGE_SEAM:      {id: 50, isWall:  true, isFluid: false, maxSlope: undefined, crystalYield: 0, oreYield: 0, inspectColor: "#FFFF00"},
} as const;
