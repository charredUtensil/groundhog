...
const TILES = { 
  ...
  WASTE_RUBBLE_4:   {id: 60, name: "Rubble 4 (Waste)",    canLandslide: false, crystalYield: 0, hardness: Hardness.RUBBLE, isFluid: false, isWall: false, maxSlope: undefined, oreYield: 0, trigger:    null },
  WASTE_RUBBLE_3:   {id: 61, name: "Rubble 3 (Waste)",    canLandslide: false, crystalYield: 0, hardness: Hardness.RUBBLE, isFluid: false, isWall: false, maxSlope: undefined, oreYield: 0, trigger:    null },
  WASTE_RUBBLE_2:   {id: 62, name: "Rubble 2 (Waste)",    canLandslide: false, crystalYield: 0, hardness: Hardness.RUBBLE, isFluid: false, isWall: false, maxSlope: undefined, oreYield: 0, trigger:    null },
  WASTE_RUBBLE_1:   {id: 63, name: "Rubble 1 (Waste)",    canLandslide: false, crystalYield: 0, hardness: Hardness.RUBBLE, isFluid: false, isWall: false, maxSlope: undefined, oreYield: 0, trigger:    null },
