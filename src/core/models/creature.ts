...
export function monsterForBiome(biome: Biome): CreatureTemplate {
  switch (biome) {
    case "rock": return ROCK_MONSTER
    case "ice": return ICE_MONSTER
    case "lava": return LAVA_MONSTER
  }
}
...
export class CreatureFactory {
  private id: number = 0
  create(args: EntityPosition & {template: CreatureTemplate, sleep?: boolean}): Creature {
