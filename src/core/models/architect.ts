import { CavernWithPartialPlans, CavernWithPlans, CavernWithPlansAndBaseDiorama, CavernWithPlansAndRoughDiorama } from "./cavern";
...
export type BaseArchitect = {
  ...
  rough(args: {cavern: CavernWithPlansAndBaseDiorama, plan: Plan, diorama: MutableRoughDiorama}): void;
