...
import { CollapseUnion, filterTruthy } from "../../common/utils";
...
function creatureSpawnScript(
  ...
  return scriptFragment(
    ...
    !opts.spawnEvent && scriptFragment(
      // Arm
    ...
    // within cooldown.
    opts.reArmMode === "hoard" && scriptFragment(
