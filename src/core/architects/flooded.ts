...
const FLOODED: readonly Architect<unknown>[] = [
  {
    ...
    caveBid: ({ plan }) => plan.fluid === Tile.WATER && plan.pearlRadius < 10 && 1
  },
  {
    name: "Island",
    ...BASE,
    ...
    caveBid: ({ plan }) => plan.fluid === Tile.WATER && plan.pearlRadius > 5 && 2
  },
  {
    name: "Lava Lake",
    ...BASE,
    ...
    caveBid: ({ plan }) => plan.fluid === Tile.LAVA && plan.pearlRadius < 10 && 1
  },
  {
    name: "Lava Island",
    ...BASE,
    ...
    caveBid: ({ plan }) => plan.fluid === Tile.LAVA && plan.pearlRadius > 5 && 1
  },
  {
    name: "Peninsula",
    ...BASE,
